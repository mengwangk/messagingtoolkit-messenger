...
namespace MessagingToolkit.Messenger.Model
{
    ...
    public sealed class DeviceInfo
    {
        ...
        public string ProviderMMSC { get; set; }

        public string ProviderAPN { get; set; }

        public string ProviderWAPGateway { get; set; }

        public string ProviderAPNAccount { get; set; }

        public string ProviderAPNPassword { get; set; }
    }
}
